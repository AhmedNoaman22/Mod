...
class BudgetLine(models.Model):
    ...
    actually_time_sheet_hour = fields.Float(string='Timesheets Hours', compute='compute_actually_hours', copy=False, precompute=True)
    actually_cost_hour = fields.Float(string='Actually Cost', compute='compute_actually_hours', copy=False, precompute=True)
