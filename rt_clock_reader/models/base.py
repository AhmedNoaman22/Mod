...
class ZK(object):
    ...
    def __init__(self, ip, port=4370, timeout=60, password=False, force_udp=False, ommit_ping=False, verbose=False,
                 encoding='UTF-8'):
        """
    ...
    def get_attendance(self):
        ...
        """
        print('in the fun of get attendance =============')
        self.read_sizes()
